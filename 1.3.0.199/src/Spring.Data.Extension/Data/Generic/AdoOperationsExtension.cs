...
namespace Spring.Data.Generic
{
    ...
    public static class AdoOperationsExtension
    {
        ...
        /// <summary>
        /// Query database with given SQL command and processes each row by a 
        /// <see cref="RowCallbackDelegate"/> with help of optional ordinal 
        /// cache and/or the rows expected value for better performance.
        /// </summary>
        /// <param name="operations">
        /// An <see cref="Spring.Data.Generic.IAdoOperations"/> object to 
        /// perform database operation.
        ...
        /// The row delegate to process each row.
        /// </param>
        /// <param name="ordinalCache">
        /// The <see cref="IDataRecordOrdinalCache"/> that caches the mapping
        /// from field name to field index.
        ...
        private static IResultSetExtractor<object> MakeResultSetExtractor(
