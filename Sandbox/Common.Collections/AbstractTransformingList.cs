...
{
    /// <summary>
    /// Provide basic functions to construct a new strong typed list
    /// of type <typeparamref name="TTo"/> from anothe strong typed list
    ...
    public abstract class AbstractTransformingList<TFrom, TTo> : AbstractList<TTo>
    {
        ...
        /// </summary>
        /// <remarks>
        /// This implementaiton always throw <see cref="NotSupportedException"/>.
        /// Subclass that supports reverse convertion should override and provide 
        ...
        /// <exception cref="NotSupportedException">
        /// This implementation always throw this exception.
        /// </exception>
