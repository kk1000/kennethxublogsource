...
{
    public partial class IpAddressBlock : System.Web.UI.Page
    {
        IISBlockedIpList IpList = null;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            this.IpList = new IISBlockedIpList(this.MetaBasePath);
        ...
        private void ShowBlockedIps()
        {
            ...
            this.lblIpCount.Text = (ipDenyList.Length).ToString() + " blocked addresses";
