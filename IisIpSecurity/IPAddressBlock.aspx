<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IpAddressBlock.aspx.cs" Inherits="IisIpSecurity.IpAddressBlock" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>IP Address Block</title>
</head>
<body>
    <h1>Grant All Access Except IP Address Below</h1>
    <a href="IpAddressBlock.aspx">Reload Page</a>
    ...
    <div>    
        ...
        <asp:TextBox ID="txtAddresses" runat="server" TextMode="MultiLine" 
                     Height="246px" Width="250px"></asp:TextBox><br />        
